...
void main() {
  addNumbers(x: 10, y: 5, z: 20);
  addNumbers2(x: 5, y: 10,);
  addNumbers2(x: 5, y: 10, z: 20);

  print(addNumbers3(x: 20, y: 10));
...
// 파라미터 넣는 곳에 {}중괄호로 묶고, required 키워드를 붙여준다
...
addNumbers2({
  required int x,
  required int y,
  int z = 50  //  required를 빼고 기본값을 넣어주면 optional parameter(값이 들어와도 되고, 안들어와도 되고)
}) {
  int sum = x + y + z;
  print('x : $x');
  print('y : $y');
